...
/* Инициализация */
const textureSrc = 'https://raw.githubusercontent.com/nidorx/matcaps/master/1024/5C4E41_CCCDD6_9B979B_B1AFB0.png';
const meshes = [];
const matcap = new THREE.TextureLoader().load(textureSrc);
const init = () => {
